...
class BasicBlock(nn.Module):
    ...
    def _reset(self, bsz, d, H, W, dropout=None):
        """
...
#             self.conv2_fn.reset(self.conv2)
        self.drop.reset_mask(bsz, d, H, W, dropout=None)
    ...
    def __init__(self, cfg, **kwargs):
        ...
        if self.downsample_times > 2:
            for i in range(3, self.downsample_times+1):
                ...
                self.downsample.add_module(f"DS{i}-RELU", nn.ReLU())
